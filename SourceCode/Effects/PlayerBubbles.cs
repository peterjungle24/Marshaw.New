// this code was basically pasted from DNSpy and forked to work to the Player instead of only Lizards
// literally
// this code was "made" while i was starting at the modding so nothing was documented. sorry.
namespace SourceCode.Effects
{
    public class PlayerBubbles : CosmeticSprite
    {
        ...
        public override void Update(bool eu)
        {
            ...
            {
                flag = (this.pos.y < this.room.FloatWaterLevel(this.pos));
            }
            if (flag)
            {
                this.vel *= 0.9f;
