...
{
    public class Marshaw
    {
        public static SlugcatStats.Name slugcat { get => SourceCode.Plugin.slgMarshaw; }
        ...
        {
            public static void FeatureHooks()
            {
            ...
            public static Player.ObjectGrabability SpearDealer(On.Player.orig_Grabability orig, Player self, PhysicalObject obj)
            {
                ...
                if (self.SlugCatClass == Marshaw.slugcat)
                {
                    // if object is Spear
                    if (obj is Spear)
                    {
            ...
            public static void Pupify(On.Player.orig_ctor orig, Player self, AbstractCreature abstractCreature, World world)
            {
                ...
                if (self.slugcatStats.name == Marshaw.slugcat)
                {
